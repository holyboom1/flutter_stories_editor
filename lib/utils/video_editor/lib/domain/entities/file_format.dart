...
class VideoExportFormat extends FileFormat {
  ...
  static const VideoExportFormat avi =
      VideoExportFormat('avi', mimeType: 'video/x-msvideo');
  static const GifExportFormat gif = GifExportFormat();
  static const VideoExportFormat mov =
      VideoExportFormat('mov', mimeType: 'video/quicktime');
  static const VideoExportFormat mp4 =
      VideoExportFormat('mp4', mimeType: 'video/mp4');
}
...
class CoverExportFormat extends FileFormat {
  ...
  static const CoverExportFormat jpg =
      CoverExportFormat('jpg', mimeType: 'image/jpeg');
  static const CoverExportFormat png =
      CoverExportFormat('png', mimeType: 'image/png');
  static const CoverExportFormat webp =
      CoverExportFormat('webp', mimeType: 'image/webp');
}
