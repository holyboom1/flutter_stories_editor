...
class _AudioTrimViewerState extends State<AudioTrimViewer> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      final RenderBox? renderBox = _trimmerAreaKey.currentContext?.findRenderObject() as RenderBox?;
      final double? trimmerActualWidth = renderBox?.size.width;
      ...
      audioPlayerController.seek(const Duration());
      ...
      setState(() {
        ...
        if (widget.maxAudioLength > const Duration() && widget.maxAudioLength < totalDuration) {
        ...
        _audioEndPos =
            fraction != null ? _audioDuration.toDouble() * fraction! : _audioDuration.toDouble();
