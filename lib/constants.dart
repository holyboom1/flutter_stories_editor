...
class Constants {
  ...
  static List<TextStyle> fonts = <TextStyle>[
    const TextStyle(
        fontFamily: 'packages/flutter_stories_editor/Montserrat',
    ...
    const TextStyle(
        ...
        fontWeight: FontWeight.w100,
        fontStyle: FontStyle.italic),
    const TextStyle(fontFamily: 'packages/flutter_stories_editor/Poiret One'),
    const TextStyle(
        fontFamily: 'packages/flutter_stories_editor/Poppins',
        fontWeight: FontWeight.w900,
        fontStyle: FontStyle.normal),
    const TextStyle(
        fontFamily: 'packages/flutter_stories_editor/Poppins',
    ...
    const TextStyle(
        ...
        fontWeight: FontWeight.w100,
        fontStyle: FontStyle.italic),
    const TextStyle(fontFamily: 'packages/flutter_stories_editor/Staatliches'),
    const TextStyle(
        fontFamily: 'packages/flutter_stories_editor/Teachers',
        fontWeight: FontWeight.w900,
        fontStyle: FontStyle.normal),
    const TextStyle(
        fontFamily: 'packages/flutter_stories_editor/Teachers',
